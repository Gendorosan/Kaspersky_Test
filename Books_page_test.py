...
# TODO: Проверить так ли это, если да, прикрутить регистрацию
"""
Для проверки добавления товаров в корзину необходимо авторизироваться
В обычных условиях был бы использован заранее созданный тестовый аккаунт, однако в рамках этого проекта использование 
такого аккаунта невозможно т.к. сайт периодически удаляет созданных пользователей
"""
